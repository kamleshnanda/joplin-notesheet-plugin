...
| ⏳  | M18 — Drawings & charts: image / shape `.xlsx` round-trip, charts in HTML / PDF export, chart fidelity (per-series colours, rich-text titles, percentStacked, more types, markers, error bars) — backlog groups A–C _(in progress)_                                    | [#36](https://github.com/kamleshnanda/joplin-notesheet-plugin/pull/36)                                                                                                                                                                                                                      |
| ⏳  | M18 — Rich Text editor data-loss fix: wrap rendered notesheet blocks in `joplin-editable` / `joplin-source` so editing in TinyMCE round-trips the fence losslessly (regression from M16's HTML-table render)                                                           | [#37](https://github.com/kamleshnanda/joplin-notesheet-plugin/pull/37)                                                                                                                                                                                                                      |
